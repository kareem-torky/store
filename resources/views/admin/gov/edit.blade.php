...
<div class="note note-info">
    <h3> @lang('site.editItem') ( @lang('site.gov') ) </h3>
</div>
        ...
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form">
                    <form role="form" method="post" action="{{ route('admin.put.gov.update') }}"  enctype="multipart/form-data">
                           ...
                           <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <textarea class="form-control count-text-desc-keywords" name="desc" rows="4"> @if($row->desc !== null) {{ strip_tags($row->desc) }} @endif</textarea>
                                        <input type="hidden" name="id" value="{{ $row->id }}"  >
                                    </div>
                                </div>
                            </div>

...
<div class="note note-info">
    <h3> @lang('site.editItem') ( @lang('site.services') ) </h3>
</div>
        ...
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form">
                    ...
                    <form role="form" method="post" action="{{ route('admin.put.service.update') }}" enctype="multipart/form-data" >
                        <div class="form-body row">
                           ...
                           <div class="col-sm-12">
                               <div class="form-group">
                                   <img id="output" class="privew-image" @if($row->img) src="  {{ getImage(SERVICE_PATH.$row->img) }}"  @endif />
                               </div>
                           </div>

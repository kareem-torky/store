...
<div class="note note-info">
    <h3> @lang('site.view') ( @lang('site.messages') ) </h3>
</div>
    ...
    <div class="col-md-12">
        ...
        <div class="portlet light bordered">
            ...
            <div class="portlet-body">
                ...
                @if($messages->count())
               <form action="{{ route('admin.post.message.deleteMulti') }}" method="post" id="Form2">@csrf</form>
                        ...
                        <tbody class="connected-sortable">
                            ...
                            <tr class="odd gradeX ">
                                ...
                                <td class="text-center"> {{ $news->message }} </td>

                                <td class="text-center">
                                    <a href="{{ route('admin.get.message.delete',$news->id) }}" class="conform-delete btn btn-danger">

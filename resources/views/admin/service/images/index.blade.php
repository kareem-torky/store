...
<div class="page-bar">
    ...
    <ul class="page-breadcrumb">
        ...
        <li>
            <a href="{{ route('admin.get.service.index') }}" class="active-bread">
            @lang('site.services')
            </a>
            <i class="fa fa-circle"></i>
        </li>
...
<div class="note note-info">
    <h3>  ( @lang('site.services') ) @lang('site.images') <span> ( {{ $service->name }} ) </span> </h3>
</div>
        ...
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form">
                    <form role="form" method="post" action="{{ route('admin.post.service.moreImages') }}" enctype="multipart/form-data" class="">
                    ...
                    <div class="tiles">
                        ...
                        <div class="tile image double selected">
                            <div class="tile-body">
                                <img src="{{ getImage(SERVICE_IMAGES_PATH.$img->img) }}" alt=""> 
                            </div>
                            <div class="tile-object view-img">
                                <div class="name"> </div>
                                <div class="number red"> 
                                    <a href="{{ route('admin.get.service.delete.image',$img->id) }}" class="red conform-delete" title="@lang('delete')">

...
<div class="page-bar">
    ...
    <ul class="page-breadcrumb">
        ...
        <li>
            <a href="{{ route('admin.get.category.index') }}" class="active-bread">@lang('site.services')</a>
            <i class="fa fa-circle"></i>
        </li>
        <li>
...
<div class="note note-info">
    <h3> @lang('site.addItem')  ( @lang('site.services') ) </h3>
</div>
        ...
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form">
                    <form role="form" method="post" action="{{ route('admin.post.service.store') }}" enctype="multipart/form-data">

...
<div class="note note-info">
    <h3> @lang('site.baseSetting') ( @lang('site.seo') ) </h3>
</div>
        ...
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form">
                    <form role="form" method="post" action="{{ route('admin.post.settings.updateSeo') }}" enctype="multipart/form-data" class="">
                        ...
                        <div class="col-sm-12">
                          ...
                          <div class="col-sm-12">
                               <div class="form-group">
                                    <label> @lang('site.seoData.googleAnalytics') </label>
                                    <div class="input-group">
                                        <span class="input-group-addon input-circle-left">
                                            <i class="fa fa-text-width"></i>
                                        </span>
                                        <textarea class="form-control" name="googleAnalytics" rows="4">{{ seoData($seoData,'googleAnalytics') }}</textarea>
                           ...
                           <div class="col-sm-12">
                               <div class="form-group">
                                    <label> @lang('site.seoData.webMaster') </label>
                                    <div class="input-group">
                                        <span class="input-group-addon input-circle-left">
                                            <i class="fa fa-text-width"></i>
                                        </span>
                                        <textarea class="form-control" name="webMaster" rows="4">{{ seoData($seoData,'webMaster') }}</textarea>
                           ...
                           <div class="col-sm-12">
                               <div class="form-group">
                                    <label> @lang('site.seoData.tagMangerHead') </label>
                                    <div class="input-group">
                                        <span class="input-group-addon input-circle-left">
                                            <i class="fa fa-text-width"></i>
                                        </span>
                                        <textarea class="form-control" name="tagMangerHead" rows="4">{{ seoData($seoData,'tagMangerHead') }}</textarea>
                           ...
                           <div class="col-sm-12">
                               <div class="form-group">
                                    <label> @lang('site.seoData.tagMangerBody') </label>
                                    <div class="input-group">
                                        <span class="input-group-addon input-circle-left">
                                            <i class="fa fa-text-width"></i>
                                        </span>
                                        <textarea class="form-control" name="tagMangerBody" rows="4">{{ seoData($seoData,'tagMangerBody') }}</textarea>

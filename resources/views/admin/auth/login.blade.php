...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Dashboard | Login | Name Of Site</title>
        ...
        <link href="{{aurl()}}/pages/css/login.min.css" rel="stylesheet" type="text/css" />
    ...
    <body class=" login">
        ...
        <div class="logo">
            <a href="index.html">
                <img src="{{aurl()}}/pages/img/logo-big.png" alt="" /> </a>
        </div>
        <!-- END LOGO -->
        <!-- BEGIN LOGIN -->
        <div class="content">
            <!-- BEGIN LOGIN FORM -->
            <form class="login-form" action="{{ route('admin.post.authadmin.do_login') }}" method="post">
        ...
        <div class="copyright"> 2019 © SeoEra. Admin Dashboard . </div>
        <!--[if lt IE 9]>
        ...
        <!-- END CORE PLUGINS -->
        <!-- BEGIN PAGE LEVEL PLUGINS -->
        <script src="{{aurl()}}/global/plugins/jquery-validation/js/jquery.validate.min.js" type="text/javascript"></script>
        <script src="{{aurl()}}/global/plugins/jquery-validation/js/additional-methods.min.js" type="text/javascript"></script>
        ...
        <script src="{{aurl()}}/pages/scripts/login.min.js" type="text/javascript"></script>
